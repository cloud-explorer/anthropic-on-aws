...
class ToolConfig:
    ...
    SUMMARY_PROMPT = """ 
                ...
                Before summarizing the doctor's note, include the full transcript. Replace just the xml tag in the transcription (<transcript> and </transcript>) with empty string.
